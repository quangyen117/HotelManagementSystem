<%-- 
    Document   : about
    Created on : Feb 19, 2021, 3:20:05 PM
    Author     : HMT
--%>
        ...
        <div class="row ">
          <div class="col-md-4">
            <div class="post-entry">
                <img src="<c:url value="/resources/images/person_1.jpg"/>" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
                <img src="<c:url value="/resources/images/person_2.jpg"/>" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
                <div class="category">Staff</div>
          ...
          <div class="col-md-4">
            <div class="post-entry">
                <img src="<c:url value="/resources/images/person_3.jpg"/>" alt="Image placeholder" class="img-fluid">
              <div class="body-text">
