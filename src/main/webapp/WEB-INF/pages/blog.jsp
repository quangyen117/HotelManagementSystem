<%-- 
    Document   : blog
    Created on : Feb 19, 2021, 3:37:51 PM
    Author     : HMT
--%>
        ...
        <div class="row mb-5">
          <div class="col-md-4">
            <div class="post-entry">
                <a href="blog-single.html"><img src="<c:url value="/resources/images/img_3.jpg"/>" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
                <a href="blog-single.html"><img src="<c:url value="/resources/images/img_6.jpg"/>" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
          ...
          <div class="col-md-4">
            <div class="post-entry">
                <a href="blog-single.html"><img src="<c:url value="/resources/images/img_5.jpg"/>" alt="Image placeholder" class="img-fluid"></a>
              <div class="body-text">
