<%-- 
    Document   : all_promotions
    Created on : Mar 16, 2021, 8:53:11 AM
    Author     : USER
--%>
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">View Promotions</div>
                                </div>
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li>
                                        <a class="parent-item">Promotions</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <li class="active">View Promotions</li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-box">
                                    <div class="card-head">
                                        <header>View Promotions</header>
                                    </div>
                                    <div class="card-body ">
                                        <div class="row p-b-20">
                                            <div class="col-md-6 col-sm-6 col-6">
                                                <div class="btn-group">
                                                    <a href="${pageContext.request.contextPath}/hotelManagement/promotion/add-promotion" id="addRow" class="btn btn-info">
                                            ...
                                            <table class="table table-hover table-checkable order-column full-width" id="example4">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="center"> For Room Type </th>
                                                        <th class="center"> Action </th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <c:forEach items="${promotions}" var="ps">
                                                        <tr class="odd gradeX">
                                                            <td class="center">${ps.name}</td>
                                                            <td class="center">
                                                                <fmt:formatDate pattern="dd/MM/yyyy" value="${ps.startDate}"/>
                                                            </td>
                                                            <td class="center">
                                                                <fmt:formatDate pattern="dd/MM/yyyy" value="${ps.endDate}"/>
                                                            </td>
                                                            <td class="center">
                                                                <c:if test="${ps.status == 'AVAILABLE'}">
                                                                    <span class="label label-sm label-success">${ps.status}</span>
                                                                </c:if>
                                                                <c:if test="${ps.status == 'UNAVAILABLE'}">
                                                                    <span class="label label-sm label-secondary">${ps.status}</span>
                                                                </c:if>    
                                                            </td>
                                                            <td class="center">
                                                                ${ps.discount} %
                                                            ...
                                                            <td class="center">
                                                                <c:forEach items="${promotionService.getRoomTypesInRelationByPromotionId(ps.id)}" var="rtipi">
                                                                    - ${rtipi} -<br/>
                                                                </c:forEach>
                                                            </td>
                                                            <td class="center">
                                                                <a href="${pageContext.request.contextPath}/hotelManagement/promotion/edit-promotion/${ps.id}" class="btn btn-primary">Edit</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
