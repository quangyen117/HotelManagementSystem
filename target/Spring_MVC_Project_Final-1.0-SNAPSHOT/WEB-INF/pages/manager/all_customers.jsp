<%-- 
    ...
    Created on : Mar 29, 2021, 10:12:25 AM
    Author     : USER
--%>
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Customer Info</div>
                                </div>
                                                ...
                                                <tbody>
                                                    <c:forEach items="${bookings}" var="bs">
                                                        <tr>
                                                            ...
                                                            <td class="text-center">${bs.gender}</td>
                                                            <td class="text-center">
                                                                <fmt:formatDate pattern="dd/MM/yyyy" value="${bs.birthDate}"/>
                                                            </td>
