            ...
            <div class="page-container">	
                ...
                <div class="page-content-wrapper">
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li><a class="parent-item">Services</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    <c:if test="${action == 'add'}">
                        ...
                        <mvc:form action="${pageContext.request.contextPath}/hotelManagement/service/${action}" method="post" modelAttribute="service" name="validateForm" >
                                        ...
                                        <div class="card-body row">
                                            <div class="col-lg-6 p-t-20">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="nameId" class="form-control" name="name" value="${service.name}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 p-t-20">
                                                <div class="form-group">
                                            ...
                                            <div class="col-lg-6 p-t-20">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="priceId" class="form-control" name="price" value="${service.price}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 p-t-20">
                                                <div class="form-group">
                                                    <label for="locationId">Location</label>
                                                    <input type="text" id="locationId" class="form-control" name="location" value="${service.location}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 p-t-20">
                                                <div class="form-group">
                                                    <label for="timeId">Time</label>
                                                    <input type="text" id="timeId" class="form-control" name="time" value="${service.time}">
                                                </div>
                                            </div>    
                                            <div class="col-lg-6 p-t-20">
                                                <div class="form-group">
                                                    <label for="desId">Description</label>
                                                    <textarea id="desId" class="form-control" name="description">${service.description}</textarea>
                                                </div>
                                            </div>    
                                            ...
                                            <div class="col-lg-6 p-t-20 text-center">
                                                <div class="form-group">
                                                    <a class="btn btn-primary" href="<c:url value="/hotelManagement/service/view-service" />">Return</a>
                                                </div>
                                            </div>     
                                        </div>
                                    </div>
