<%-- 
    Document   : all_rooms
    Created on : Mar 8, 2021, 9:36:29 AM
    Author     : USER
--%>
                        ...
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                ...
                                <ol class="breadcrumb page-breadcrumb pull-right">
                                    ...
                                    <li>
                                        <a class="parent-item">Rooms</a>&nbsp;<i class="fa fa-angle-right"></i>
                                    </li>
                                    ...
                                    <div class="card-body ">
                                        <div class="row p-b-20">
                                            <div class="col-md-6 col-sm-6 col-6">
                                                <div class="btn-group">
                                                    <a href="${pageContext.request.contextPath}/hotelManagement/room/add-room" id="addRow" class="btn btn-info">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${rooms}" var="rs">
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="center">
                                                                <a href="${pageContext.request.contextPath}/hotelManagement/room/edit-room/${rs.id}" class="btn btn-primary">Edit</a>
                                                                <a href="${pageContext.request.contextPath}/hotelManagement/room/change-status/${rs.id}" class="btn btn-success"><i class="fa fa-repeat"></i> Status</a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
